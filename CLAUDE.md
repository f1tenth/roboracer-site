...
3. No binary over 1.5 MB enters git. Video and large GIFs go to Cloudflare (see skill `roboracer-media`); images are compressed to WebP/AVIF with a poster for every video. Existing oversized files in `public/landing` get replaced, not duplicated.
