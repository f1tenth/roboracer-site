...
## Hero cinematic v1 trial (director, overnight 2026-08-30; docs/hero-lab/REPORT.md)

Provenance for every row: AI-generated (Higgsfield, model and job below) from RoboRacer organizer references (Felix Jahncke DSLR frames P1033246, P1023020, P1033125, P1022612, P1022992, P1023017; Cedric's `over-the-bridge.jpg` and two frames of `LamarrRacingFollowUp.MOV`; `docs/hero-lab/REFS.md`), ICRA 2026 Vienna. Permission: granted (own media). Not used on any page until Cedric decides; reachable on the `revamp/hero-cinematic` branch only.

| id | file | type | dims | size | content | source | credit | permission | used by |
|---|---|---|---|---|---|---|---|---|---|
| HC-01 | `public/media/hero-cine/d/f_0001.webp` .. `f_0121.webp` (git-ignored, local; R2 upload is the follow-up) | webp x121 | 1280x720 | 5.93 MB total, avg 49 KB | the film: two cars on the hall straight, a slow push-in, the left car pulls half a length ahead | `_harvest/higgsfield/20260830-024330-seedance_2_0_mini-.../result.mp4`, take C, AI-generated (Higgsfield `seedance_2_0_mini`, job `59c31927-9c62-4817-aa32-3f52b278c7ed`) from the locked still (Nano Banana Pro, job `e089addb-c052-4044-aa1e-3eb5a65db2b3`) and the references above; cut by `scripts/frames.sh` at 24 fps, q74 | AI-generated from organizer media; no photo credit line on the page | granted (own media) | HeroCinematic desktop set (from 768px) |
| HC-02 | `public/media/hero-cine/m/f_0001.webp` .. `f_0080.webp` (git-ignored, local) | webp x80 | 960x540 | 2.41 MB total, avg 30 KB | same film resampled to 15.9 fps | as HC-01, q60 | as HC-01 | granted (own media) | HeroCinematic mobile set (under 768px) |
| HC-03 | `public/media/hero-cine/poster-1280.webp` | webp | 1280x720 | 56 KB | frame 1 of the film: the locked composition | as HC-01, frame 1 at q80 | as HC-01 | granted (own media) | HeroCinematic poster (desktop), the reduced-motion image |
| HC-04 | `public/media/hero-cine/poster-960.webp` | webp | 960x540 | 36 KB | frame 1 of the mobile set | as HC-02, frame 1 at q78 | as HC-01 | granted (own media) | HeroCinematic poster (mobile) |
| HC-05 | `docs/hero-lab/locked-frame-1200.jpg` | jpg | 1200x670 | 96 KB | the locked still (round 3b) for the morning review | `_harvest/higgsfield/locked-frame.png` (2752x1536), AI-generated (Higgsfield `nano_banana_2` = Nano Banana Pro, job `e089addb-c052-4044-aa1e-3eb5a65db2b3`) | as HC-01 | granted (own media) | docs only |
| HC-06 | `docs/hero-lab/stills/round-{1,2,3}.jpg`, `docs/hero-lab/takes/take-{A,B,C}-sheet.jpg` | jpg | 964 / 1920 wide | 96-332 KB | contact sheets of the ten stills and the three takes | the job directories under `_harvest/higgsfield/` | as HC-01 | granted (own media) | docs only |

## Hero cinematic v2 (director + agents, morning 2026-08-30; docs/hero-lab/v2/ACTS.md)

Provenance for every row: AI-generated (Higgsfield, model and job below) from RoboRacer organizer references (Cedric's `AI_Generated_Car_ICRA26.png` and Unicorn photos, Felix Jahncke frames P1023020 / P1022612 / P1033125 / P1022992 / P1023017, two frames of `LamarrRacingFollowUp.MOV` and `RedCarFastICRA.MOV`) and renders of the site's own three.js CAD assembly (`docs/hero-lab/v2/CAD_REFS.md`), ICRA 2026 Vienna. Permission: granted (own media). The v2 frame set replaced the v1 set under `public/media/hero-cine/` (rows HC-01..04 now describe v2).

| id | file | type | dims | size | content | source | credit | permission | used by |
|---|---|---|---|---|---|---|---|---|---|
| HC-01v2 | `public/media/hero-cine/d/f_0001.webp` .. `f_0200.webp` (git-ignored, local) | webp x200 | 1280x720 | 7.56 MB, avg 38 KB | the four-act film: chase and pass on the Unicorn car, drone move to the side, the hall dissolving into a void, the CAD explosion | `_harvest/higgsfield/v2-film.mp4` = Seedance 2.0 Mini clips `d53c8ebf`-style jobs in `_harvest/higgsfield/20260830-085954-*` (A1), `20260830-090420-*` (A23), `20260830-090728-*` (A4, trimmed to 2.5 s), joined by `scripts/film-assemble.sh`; cut at 15.3 fps q74 | AI-generated from organizer media and the site's CAD | granted (own media) | HeroCinematic desktop set |
| HC-02v2 | `public/media/hero-cine/m/f_0001.webp` .. `f_0080.webp` (git-ignored, local) | webp x80 | 960x540 | 2.07 MB | same film at 6.1 fps | as HC-01v2, q72 | as HC-01v2 | granted (own media) | HeroCinematic mobile set |
| HC-03v2 | `public/media/hero-cine/poster-1280.webp`, `poster-960.webp` | webp | 1280x720, 960x540 | 64 / 35 KB | frame 1: the chase behind our car | as HC-01v2 | as HC-01v2 | granted (own media) | HeroCinematic posters, the reduced-motion image |
| HC-07 | `docs/hero-lab/v2/acts-sheet.jpg` | jpg | 1284x718 | 154 KB | the four key frames (Nano Banana Pro jobs in `_harvest/higgsfield/20260830-0854*`, `0857*`, `0901*`, `0904*`) | AI-generated stills | as HC-01v2 | granted (own media) | docs only |
| HC-08 | `docs/hero-lab/v2/takes/a1-sheet.jpg`, `a23-sheet.jpg`, `a4-sheet.jpg` | jpg | 1920 wide | 250-330 KB | contact sheets of the three clips | as HC-01v2 | as HC-01v2 | granted (own media) | docs only |
| HC-09 | `docs/hero-lab/v2/cad-refs-sheet.jpg` | jpg | 1448x1092 | 200 KB | 12 renders of the site's three.js CAD assembly (`/assembly`) at the chapter's lens | rendered by an agent from `public/models/racecar/` | site-owner | granted | docs only; references for KF4/KF5/A4 |
