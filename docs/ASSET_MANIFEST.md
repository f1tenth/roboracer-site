...
| SP-04 | `public/media/spinoffs/spinoff-neobotics-site-960.webp` | webp | 960x600 | 15,322 B | the neobotics.org homepage above the fold: header and menu over the FPV hero video along an orange barrier, typed line "Empowering the future of autonomous racing" | our capture of `https://neobotics.org/` at 1280x800 (frame with the typed line complete) | our render of Neobotics' site | Cedric-directed 2026-09-25; Neobotics not yet asked | spinoffs.json `Neobotics` preview |
...
| id | file | type | dims | size | content | source | credit | permission | used by |
|---|---|---|---|---|---|---|---|---|---|
| RACE-LB-01 | `public/media/race/race-leaderboard-replay-wide.webp` | webp | 1960x1350 | 49 KB | the board's player, "Top 5 / Fastest clean lap": Levine hallway track, five labelled cars (Teams 10, 8, 4, 6, 3, the top 5 as of 2026-09-26 02:30Z) with their paths, readout, standings, controls | frame window 1040x720, dialog crop 980x675 at (30, 22.5), 2x | ESE 6150 leaderboard (RoboRacer-Class) | the course's own board; Cedric, 2026-09-25 | poster of the replay on /race#leaderboard, columns 640 px and wider |
| RACE-LB-02 | `public/media/race/race-leaderboard-replay-narrow.webp` | webp | 804x1294 | 36 KB | the same moment in the player's phone layout (track above the readout strip, standings in one column, controls in three rows) | frame window 440x720, dialog crop 402x647 at (19, 36.4), 2x | ESE 6150 leaderboard (RoboRacer-Class) | the course's own board; Cedric, 2026-09-25 | poster of the replay on /race#leaderboard, narrower columns (phones, lg below ~1155 px) |
