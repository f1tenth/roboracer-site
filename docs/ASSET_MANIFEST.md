...
## About: spinoff features (2026-09-25)

Cedric, 2026-09-25: "Neobotics should have a preview of their car / logo and website when we mention them as a spinoff. Quanser should just be featured as a spinoff and again visually like we need to do for Neobotics", and, the same day, "we actually want to kinda embed their website (summarized) when we feature them". That is an explicit exception to CLAUDE.md rule 8 and to the media skill's "never neobotics.org assets / screenshots of other people's websites", for these two features only. Every file below is **Cedric-directed 2026-09-25; the company has not been asked** (Neobotics not yet asked, Quanser not yet asked). The two homepage previews are our own Playwright renders of the public homepage at 1280x800 (Chromium, 2026-09-25), resized to 960x600 WebP q80; nothing from them is re-used elsewhere. The NeoRacer paper (arXiv 2607.26855) was checked first as a source for the car: its licence is arXiv's non-exclusive distribution licence 1.0, not CC BY, so no figure was taken from it. Wikimedia Commons has no Quanser logo (searched 2026-09-25). Used by `public/data/spinoffs.json` entries (About, section 05) through `src/components/about/SpinoffGrid.tsx`; credits stay here and in the JSON `source` fields, not on the page.

| id | file | type | dims | size | content | source | credit | permission | used by |
|---|---|---|---|---|---|---|---|---|---|
| SP-01 | `public/partners/neobotics.webp` (+ `partners/color/neobotics.webp` 134x104 3,236 B and `partners/tint/neobotics.webp` 134x104 2,612 B, trimmed by `scripts/partner-trim.py`) | webp | 1920x1920 | 31,214 B | the red Neobotics "N" mark on white, unmodified | byte-identical to `https://neobotics.org/images/logos/neobotics/neobotics-icon-red.webp`; added in commit 13513e9 (2026-08-23) for the partner wall, without a manifest row until now | Neobotics Foundation | partner wall: partner logo already on the site; spinoff use: Cedric-directed 2026-09-25, Neobotics not yet asked | partners.json `Neobotics Foundation`; source of SP-02 |
| SP-02 | `public/media/spinoffs/spinoff-neobotics-icon-96.webp` | webp | 128x96 | 2,220 B | the red Neobotics "N" mark | SP-01 trimmed to the mark, resized to 96 high | Neobotics Foundation | Cedric-directed 2026-09-25; Neobotics not yet asked | spinoffs.json `Neobotics` logo |
| SP-03 | `public/media/spinoffs/spinoff-neobotics-car-1200.webp` | webp | 1200x800 | 38,960 B | the NeoRacer three-quarter view in a dark studio with smoke: black body, orange wheels, rear wing, lidar | `https://neobotics.org/images/studio/neoracer_studio_angle_dark_smoke.webp` (1448x1086, gallery on `https://neobotics.org/kits`), crop 1448x965+0+90, resized to 1200x800 | Neobotics Foundation | Cedric-directed 2026-09-25; Neobotics not yet asked | spinoffs.json `Neobotics` car |
| SP-04 | `public/media/spinoffs/spinoff-neobotics-site-960.webp` | webp | 960x600 | 37,188 B | the neobotics.org homepage past its FPV hero: the end of their vision text, then the red "NEO RACER" panel with the car (re-captured 2026-09-26: the above-the-fold frame was a motion-blurred FPV still whose only line was about 6 px tall in the 295 px window; the header menu cannot be legible at that width from a 1280 capture, so the frame is their product panel instead) | our capture of `https://neobotics.org/` at 1280x800, scrolled to y 1642 (the panel centred) after walking the page so its reveals had run, resized to 960x600, WebP q82 | our render of Neobotics' site | Cedric-directed 2026-09-25; Neobotics not yet asked | spinoffs.json `Neobotics` preview |
| SP-05 | `public/media/spinoffs/spinoff-quanser-icon-96.webp` | webp | 91x96 | 2,528 B | the red Quanser "Q" ring mark | the Q cropped from the PNG embedded in `https://www.quanser.com/wp-content/uploads/2023/02/quanser.svg` (3237x622; the white wordmark text is left out so the mark reads on paper), trimmed, resized to 96 high; the same mark is the site's favicon `https://www.quanser.com/wp-content/uploads/2023/01/favicon-1.png` | Quanser | Cedric-directed 2026-09-25; Quanser not yet asked | spinoffs.json `Quanser` logo |
| SP-06 | `public/media/spinoffs/spinoff-quanser-car-1200.webp` | webp | 1200x800 | 28,278 B | the QCar 2 three-quarter view on white: black chassis, lidar, depth camera, light strip | `https://www.quanser.com/wp-content/uploads/2024/08/QCar2-08.jpg` (2000x1344, gallery of `https://www.quanser.com/products/qcar-2/`), resized to 924 wide and set on a 1200x800 white canvas at +96+55 (the photo's own white), so the 16:9 stage keeps the whole car clear of the preview window | Quanser | Cedric-directed 2026-09-25; Quanser not yet asked | spinoffs.json `Quanser` car |
| SP-07 | `public/media/spinoffs/spinoff-quanser-site-960.webp` | webp | 960x600 | 31,252 B | the quanser.com homepage above the fold: header and menu over the dark lab hero video, "Transforming educational experiences accelerating innovative research" | our capture of `https://www.quanser.com/` at 1280x800, with the site's "Book a meeting" pop-up removed before the capture | our render of Quanser's site | Cedric-directed 2026-09-25; Quanser not yet asked | spinoffs.json `Quanser` preview |

## Race: class leaderboard replay posters (2026-09-25)

Screenshots of the ESE 6150 class leaderboard's own replay player (`https://roboracer-class.github.io/leaderboard/?lab=lab-4-follow-the-gap-lap&compare=top5`, repo `RoboRacer-Class/leaderboard`, the course's own board), captured with headless Chromium at 2x inside a frame of the size the section uses, the player paused by reduced motion and seeked to 30% of the race (Team 10 on lap 2), light scheme, the focus ring cleared; cropped to the player's dialog, WebP q80. Team numbers only (no student names). Requested by Cedric, 2026-09-25 ("the live sim preview that shows the top 5 cars"). Re-capture if the board's player changes its layout: the crop sizes are in `LeaderboardReplay.tsx` and docs/LEADERBOARD.md, "The replay".

| id | file | type | dims | size | content | source | credit | permission | used by |
|---|---|---|---|---|---|---|---|---|---|
| RACE-LB-01 | `public/media/race/race-leaderboard-replay-wide.webp` | webp | 1960x1350 | 41 KB | the board's player, "Top 5 / Fastest clean lap": Levine hallway track, five labelled cars (Teams 10, 8, 4, 6, 3, the top 5 as of 2026-09-26 03:53Z) with their paths, readout and standings; the player's controls are not drawn (re-captured 2026-09-26: the poster showed Full screen, Close, Play, Compare and Copy link, which did nothing on the poster) | frame window 1040x720, dialog crop 980x675 at (30, 22.5), 2x; slider at 30% of its range; `.rr-full, .rr-close, .rr-bar { visibility: hidden }` injected into the board's page before the capture, so the box and the track sit exactly where the loaded player draws them; WebP q80 | ESE 6150 leaderboard (RoboRacer-Class) | the course's own board; Cedric, 2026-09-25 | poster of the replay on /race#leaderboard, columns 640 px and wider |
| RACE-LB-02 | `public/media/race/race-leaderboard-replay-narrow.webp` | webp | 804x1294 | 30 KB | the same moment in the player's phone layout (track above the readout strip, standings in one column); the three control rows are left blank as on RACE-LB-01 | frame window 440x720, dialog crop 402x647 at (19, 36.4), 2x; the same injected CSS; WebP q80 | ESE 6150 leaderboard (RoboRacer-Class) | the course's own board; Cedric, 2026-09-25 | poster of the replay on /race#leaderboard, narrower columns (phones, lg below ~1155 px) |
...
## News: history 2016 to 2026 (p3-news-merge, 2026-09-25)

Cedric, 2026-09-25: "The news section is missing a lot of content from the earlier days." The merge of the three candidate files (docs/news/MERGE.md) adds four photos from RoboRacer's own archive and four slides from the Foundation's own LinkedIn posts. Encoded with Pillow WebP q82, method 6, at most 1080 wide (no upscaling), all under 200 KB; raw downloads stay in the git-ignored `docs/news/_intake/`. Posts by anyone else are embedded click-to-load with no re-hosted media. Three /race timeline photos are reused as they are (no new file): `public/media/race/esweek2018.webp` (the old site's only Torino image, `https://f1tenth.github.io/gallery/torino2018/torino1.png`), `public/media/race/icra2025.webp` (the ICRA 2025 group photo Cedric added in commit 58c6a8c; photographer not recorded) and `public/media/race/iccas2025.webp` (RACE-T-05, 'RoboRacer organizers (via Cedric Hollande)'; byte-identical to a Drive photo whose file name carries the photographer's name, which the drive report treats as personal data).

| id | file | type | dims | size | content | source | credit | permission | used by |
|---|---|---|---|---|---|---|---|---|---|
| NEWS-03 | `public/media/news/news-porto2018-track-1080.webp` | webp | 1080x720 | 93 KB | competitors at their laptops beside the white tube track on the tiled floor of the Palácio da Bolsa, CPS Week 2018 corner mark | `https://f1tenth.github.io/gallery/porto2018/porto2.jpg` (2048x1365, old f1tenth.org Porto gallery), resized | F1TENTH archive (photographer not recorded) | F1TENTH/RoboRacer own archive | news.json `cpsweek2018-porto-ctu-wins` |
| NEWS-04 | `public/media/news/news-montreal2019-car-1080.webp` | webp | 1080x810 | 185 KB | a car with orange wheels on the asphalt of the Montreal racetrack, catch fence and wall behind | `https://f1tenth.github.io/gallery/montreal2019/montreal3.jpg` (4032x3024, old f1tenth.org Montreal gallery; EXIF 2019-04-21), resized | F1TENTH archive (photographer not recorded) | F1TENTH/RoboRacer own archive | news.json `cpsiot2019-montreal-unc-wins` |
| NEWS-05 | `public/media/news/news-columbia2019-cars-1080.webp` | webp | 1080x810 | 169 KB | a queue of cars on the stone floor of the Columbia hall, competitors along the barrier | `https://f1tenth.github.io/gallery/columbia2019/columbia1.jpg` (4032x3024, old f1tenth.org Columbia gallery), resized | F1TENTH archive (photographer not recorded) | F1TENTH/RoboRacer own archive | news.json `columbia2019-fifth-competition` |
| NEWS-06 | `public/media/news/news-iros2023-race-1080.webp` | webp | 1080x608 | 123 KB | two cars racing between yellow duct barriers in a convention hall, an organizer calling the race into a microphone | `rclone copy rr:"Old Banners, Flyers, Shirts, Stickers/Media to Use/IMG_3196.JPG"` (3520x1980, EXIF 2023-10-04 13:58, iPhone 11 Pro Max: IROS 2023 week, Detroit), resized | RoboRacer organizers (photographer not recorded in the Drive) | organisation-owned (RoboRacer Events Drive, 'Media to Use'); no photographer to credit | news.json `iros2023-detroit-vaul-wins` |
| NEWS-07 | `public/media/news/news-iv2024-post-800.webp` | webp | 800x418 | 46 KB | the post's card: The 18th F1Tenth Grand Prix, IEEE IV 2024, June 2-5, Jeju Shinhwa World, with a race photo | image of the Foundation's LinkedIn post `activity-7201984268267372544` (800x418, media.licdn.com feedshare-shrink_800), native size | The Roboracer Foundation | organization's own post (brief p3-news-merge: our own page, a slide may be the poster) | news.json `iv2024-18th-announced` embed poster |
| NEWS-08 | `public/media/news/news-icra2025-post-1080.webp` | webp | 1080x1529 | 155 KB | the ICRA 2025 poster: 24th RoboRacer Autonomous Racing Competition, May 19-23, 2025, Georgia World Congress Center | image of the Foundation's LinkedIn post `activity-7297948638578692096` (1085x1536), resized | The Roboracer Foundation | organization's own post | news.json `icra2025-registration-opens` embed poster |
| NEWS-09 | `public/media/news/news-season2025-post-800.webp` | webp | 800x418 | 53 KB | the 2025-26 season poster: six dated stages and three race photos | image of the Foundation's LinkedIn post `activity-7379907884333031424` (800x418), native size; the same poster is `rr:/IMG_1473.PNG` | The Roboracer Foundation | organization's own post | news.json `season-2025-26` embed poster |
| NEWS-10 | `public/media/news/news-techfest2025-post-1080.webp` | webp | 1080x1529 | 153 KB | the Techfest poster: 26th RoboRacer Autonomous Racing Competition, December 22-24, 2025, IIT Bombay | image of the Foundation's LinkedIn post `activity-7380971173129453568` (1085x1536), resized | The Roboracer Foundation | organization's own post | news.json `techfest2025-26th-announced` embed poster |

## News: photos and posters for items without media (p3-news-images, 2026-09-26)

Cut from `docs/news/MEDIA_PLAN.json` after Cedric's rulings on its approval list (2026-09-26): our own newsletter photos, the Foundation's own LinkedIn photo, the old f1tenth.org gallery photos (the Daily Pennsylvanian one captioned "mid-semester race") and the Drive posters, including RoboRacer-branded posters for races run as F1TENTH. Skipped by the same ruling: the IFAC 2026 host photo, the CPS-IoT Week 2024 newsletter photo, the IROS 2026 flyer and the Autoware delegation photo (that item takes the plan's fallback poster, NEWS-14). Encoded with Pillow WebP q80, method 6, at most 1080 wide (portrait at most 1080 tall), never upscaled, all under 200 KB; raw downloads stay in the git-ignored `docs/news/_intake/img/`. The item-to-file map for news.json is `docs/news/MEDIA_IMAGES.json`.

| id | file | type | dims | size | content | source | credit | permission | used by |
|---|---|---|---|---|---|---|---|---|---|
| NEWS-11 | `public/media/news/news-iv2025-poster-1080.webp` | webp | 764x1080 | 108 KB | the 25th competition poster: June 22-25, 2025, IEEE IV 2025, Cluj-Napoca, a car on a street with light trails under the RoboRacer wordmark | `rclone copy rr:"Posters 2026/Draft 1 (6).png"` (1414x2000 PNG, 4,448,961 B), resized | RoboRacer Foundation | organisation-owned (Drive), photographer credited; Cedric, 2026-09-26 (approval list ruling) | news.json `iv2025-cluj-forzaeth-wins` image |
| NEWS-12 | `public/media/news/news-cdc2024-poster-1080.webp` | webp | 764x1080 | 119 KB | the 22nd competition poster: Dec 16-19, 2024, CDC 2024, Milan (RoboRacer branding applied in 2026 to a race run as F1TENTH) | `rclone copy rr:"Posters 2026/17.png"` (1414x2000 PNG, 5,279,692 B), resized | RoboRacer Foundation | organisation-owned (Drive), photographer credited; Cedric, 2026-09-26 (approval list ruling) | news.json `cdc2024-milan-scuderia-segfault-wins` image |
| NEWS-13 | `public/media/news/news-bu2024-poster-1080.webp` | webp | 764x1080 | 121 KB | the 23rd competition poster: Nov 22, 2024, Learning to Trust Autonomy Workshop, Boston University (RoboRacer branding applied in 2026) | `rclone copy rr:"Posters 2026/18.png"` (1414x2000 PNG, 6,555,534 B), resized | RoboRacer Foundation | organisation-owned (Drive), photographer credited; Cedric, 2026-09-26 (approval list ruling) | news.json `bu2024-lehigh-wins` image |
| NEWS-14 | `public/media/news/news-korea-delegation-poster-1080.webp` | webp | 764x1080 | 108 KB | the 15th competition poster: May 13-17, 2024, ICRA 2024, Yokohama (fallback tile: the next race after the visit) | `rclone copy rr:"Posters 2026/12.png"` (1414x2000 PNG, 4,607,035 B), resized | RoboRacer Foundation | organisation-owned (Drive), plan fallback tile (the Autoware delegation photo is skipped); Cedric, 2026-09-26 (approval list ruling) | news.json `f1tenth-korea-delegation-upenn` image |
| NEWS-15 | `public/media/news/news-rules-repo-poster-1080.webp` | webp | 764x1080 | 98 KB | the 26th competition poster: Dec 22-24, 2025, Techfest IIT Bombay, Mumbai (fallback tile: the first race after the rules repository) | `rclone copy rr:"Posters 2026/Draft 1 (2).png"` (1414x2000 PNG, 4,345,354 B), resized | RoboRacer Foundation | organisation-owned (Drive), plan fallback tile (no photo exists for a repository launch); Cedric, 2026-09-26 (approval list ruling) | news.json `roboracer-rules-repository-2025` image |
| NEWS-16 | `public/media/news/news-roboracer-rename-1080.webp` | webp | 1080x540 | 37 KB | the newsletter's 'Under construction' header: skyline with cranes, hazard stripes, www.RoboRacer.ai | `https://mcusercontent.com/a91a25f4c1fbc0c9896af9a20/images/007d865c-53de-fae0-e1ad-41db078965fa.png` (6912x3456, 497,772 B), page https://mailchi.mp/cf1734d5a686/f1tenth-summer-newsletter-6743291, resized | F1TENTH newsletter, November 13, 2024 | own archive; Cedric, 2026-09-26 (approval list ruling) | news.json `f1tenth-to-roboracer-announced` image |
| NEWS-17 | `public/media/news/news-iros2024-abudhabi-1080.webp` | webp | 1080x810 | 167 KB | competitors and organizers in two rows behind cars and trophies at the track edge, IROS 2024 Abu Dhabi | `https://mcusercontent.com/a91a25f4c1fbc0c9896af9a20/images/ab00e70a-8d47-31d4-df88-e034b33d1062.jpg` (2048x1536, 652,106 B), page https://mailchi.mp/20e93a8ea541/f1tenth-summer-newsletter-6742752, resized | F1TENTH newsletter, October 21, 2024 | own archive; Cedric, 2026-09-26 (approval list ruling) | news.json `iros2024-abudhabi-dzik-ultimate-wins` image |
| NEWS-18 | `public/media/news/news-icra2024-yokohama-1080.webp` | webp | 578x1080 | 95 KB | Lukasz Sztyber, thumbs up, beside his car and an F1TENTH banner, ICRA 2024 Yokohama | image of the Foundation's LinkedIn post `activity-7196811928927621122` (822x1536, media.licdn.com feedshare-image-high-res), page https://www.linkedin.com/posts/roboracer-foundation_icra2024-engineering-activity-7196811928927621122-9cMs, uncropped portrait, resized to 1080 tall | The Roboracer Foundation (then F1Tenth Foundation), LinkedIn, May 16, 2024 | Foundation post; Cedric, 2026-09-26 (approval list ruling) | news.json `icra2024-yokohama-vaul-wins` image |
| NEWS-19 | `public/media/news/news-course2024-race-1080.webp` | webp | 1080x810 | 193 KB | students along a yellow-duct track on a paved plaza on 33rd Street as a car passes, Penn/CMU/Lehigh race, April 29, 2024 | `https://mcusercontent.com/a91a25f4c1fbc0c9896af9a20/images/a66af0cf-94c0-5c02-f7fc-6a1d2ef9c80f.jpg` (4032x3024, 1,733,337 B), page https://mailchi.mp/b7136669240c/f1tenth-summer-newsletter, resized | F1TENTH newsletter, July 25, 2024 | own archive; Cedric, 2026-09-26 (approval list ruling) | news.json `course2024-three-university-race` image |
| NEWS-20 | `public/media/news/news-iros2020-bracket-1080.webp` | webp | 1080x1063 | 23 KB | the IROS 2020 virtual bracket, round 3 to the final (HiPeRT Modena vs C.A.T), black type on white | `https://f1tenth.github.io/Brackets/irosbracket.png` (5692x3200, 195,128 B), page https://f1tenth.github.io/iros2020.html, crop 3250x3200+2350+0 (round 3 to final), flattened on white, resized | F1TENTH (old f1tenth.org site) | own archive; Cedric, 2026-09-26 (approval list ruling) | news.json `iros2020-virtual-hipert-wins` image |
| NEWS-21 | `public/media/news/news-foundation2020-car-1080.webp` | webp | 477x800 | 63 KB | top view of the 1/10-scale car, transparent background (alpha kept) | `https://f1tenth.github.io/landing/f110-top-transparent.png` (477x800, 611,330 B), page https://web.archive.org/web/20200509220330/http://f1tenth.org/, native size, alpha kept | F1TENTH (f1tenth.org homepage, May 2020) | own archive; Cedric, 2026-09-26 (approval list ruling) | news.json `f1tenth-foundation-2020` image |
| NEWS-22 | `public/media/news/news-medium2020-levine-1080.webp` | webp | 1080x607 | 41 KB | a car between white tube barriers on a polished floor, Levine Hall track testing, Dec 4, 2018 | `https://f1tenth.github.io/gallery/media/large/Levine%20Track%2012-4-18%20Testing/L1100185.jpg` (1778x1000, 289,234 B), page https://f1tenth.github.io/gallery/, resized | Christopher Kao (old f1tenth.org gallery, Penn ESE 680, fall 2018) | own archive; Cedric, 2026-09-26 (approval list ruling) | news.json `medium-adventures-in-autonomous-vehicles` image |
| NEWS-23 | `public/media/news/news-nsf2019-final-race-1080.webp` | webp | 1080x607 | 65 KB | a car between white tube barriers and cardboard boxes on a stone floor, Penn course final race, Dec 10, 2018 | `https://f1tenth.github.io/gallery/media/large/Final%20Race%2012-10-18/L1100823.jpg` (1778x1000, 361,410 B), page https://f1tenth.github.io/gallery/, resized | Christopher Kao (old f1tenth.org gallery, Penn ESE 680, fall 2018) | own archive; Cedric, 2026-09-26 (approval list ruling) | news.json `nsf-community-platform-award-2019` image |
| NEWS-24 | `public/media/news/news-dp2018-midsemester-1080.webp` | webp | 1080x720 | 47 KB | a car with green wheels in a corridor past an AprilTag, Penn mid-semester race, Nov 6, 2018 | `https://f1tenth.github.io/gallery/media/large/Mid-Semester%20Race%2011-6-18/L1050744.jpg` (1500x1000, 256,820 B), page https://f1tenth.github.io/gallery/, resized | Christopher Kao (old f1tenth.org gallery, Penn ESE 680, fall 2018) | own archive; Cedric, 2026-09-26 (approval list ruling) | news.json `daily-pennsylvanian-2018-dining-hall` image |

## News: pictures from third-party LinkedIn posts (content/news-linkedin-photos, 2026-09-26)

Cedric, 2026-09-26: two 2026 items that showed only a LinkedIn embed get the pictures their posts carry. Read from the public post pages with a browser user agent; every image in each post downloaded at the largest size LinkedIn serves (the `feedshare-shrink_2048_1536` variant answers 403), raw files kept in the main checkout's git-ignored `_harvest/linkedin/`. Encoded with Pillow WebP q80, method 6, at native size (both posts serve 800 wide; nothing upscaled). The post text and the "Show the LinkedIn post" embed stay on the cards. A banner wider than 2.5:1 is shown whole (object-contain on the ink ground) in `NewsCard` instead of cropped.

| id | file | type | dims | size | content | source | credit | permission | used by |
|---|---|---|---|---|---|---|---|---|---|
| NEWS-25 | `public/media/news/news-iros2026-sim-league-800.webp` | webp | 800x266 | 22 KB | AutoDRIVE's results banner: "6th RoboRacer Sim Racing League" over a simulated race car, IROS 2026 Pittsburgh, AutoDRIVE and RoboRacer marks | `https://media.licdn.com/dms/image/v2/D4E22AQFxj-rLcvoplQ/feedshare-shrink_800/B4EaDRy_lzHoAc-/0/1790226201509?e=2147483647&v=beta&t=fJgwwt_X0f7WwztyDkFIjM5XJn1JWDcUPwhzdc6aRiE` (800x266 JPEG, 32,976 B, the post's only image), post https://www.linkedin.com/posts/autodrive-ecosystem_iros2026-autodrive-roboracer-activity-7508752923695194113-2hxc (embed urn:li:share:7508752921769992192), native size | AutoDRIVE Ecosystem (LinkedIn) | third-party organisation's own post, added at Cedric's request on 2026-09-26; permission not yet requested | news.json `iros2026-sim-league-siga-siga-wins` image |
| NEWS-26 | `public/media/news/news-vtc2026-group-800.webp` | webp | 800x525 | 80 KB | the teams of the 30th competition, many holding up their cars, behind the orange and yellow duct track, Hilton Boston Park Plaza | `https://media.licdn.com/dms/image/v2/D4D22AQF_vsiyR3Gfdw/feedshare-shrink_800/B4DaDFjNdAIoAc-/0/1790020737158?e=2147483647&v=beta&t=UdZeefbn3ttRAm0YG3Uqpqz3Ta-iVTHJdr8eZEmYNik` (800x525 JPEG, 99,657 B; the post's lead image, first in its ld+json), post https://www.linkedin.com/posts/neobotics-foundation-inc_roboracer-neobotics-f1tenth-activity-7507891143662145538-xHdb (embed urn:li:ugcPost:7507891142504521730; the Foundation's repost https://www.linkedin.com/posts/roboracer-foundation_activity-7507935046394376192-Bbo1 carries the same nine images), native size. The post's other eight photos were downloaded, not used: two cars on the track with a driver holding a controller (1080x1165), the 30th Grand Prix shirt on an easel (673x967), two cars on a table (800x512), the hall and track from above (800x616), the event board with track map and participating teams (800x583), three people at the screen (800x619), an award handover on stage (800x511), a second group photo (800x534) | Neobotics Foundation (LinkedIn) | third-party organisation's own post, added at Cedric's request on 2026-09-26; permission not yet requested | news.json `vtc2026-boston-neobotics` image |
