...
- The Foundation's LinkedIn page is the old F1Tenth Foundation page, renamed: `/company/f1tenth-foundation` redirects to `/company/roboracer-foundation`. Its public page shows only the ten newest activities, so older posts were found with about 70 web searches restricted to linkedin.com (organizers, teams, events), then each post page was read with curl for its structured data (date, author, text, images) and its own share/ugcPost URN.
- About 110 posts and articles were read; slide and poster images of text-light posts were viewed (in the scratchpad, none kept). 49 were kept as candidates; 38 more are listed as leads with the reason they were not selected.
...
- 2024-05-15 Rahul Mangharam: https://www.linkedin.com/posts/mangharam_icra2024-activity-7196308422739263488-uUvq (ICRA 2024 race start: time trials Wednesday for seeding, head-to-head bracket Thursday, in the competition and exhibition zone (embed urn:li:share:7196308422256979968). ICRA 2024 already has four candidates; use if the race-week story needs a format line.)
...
- DuckDuckGo HTML search returns a bot challenge; Bing via curl returns unrelated, bot-filtered results. Discovery ran through the WebSearch tool restricted to linkedin.com (about 70 queries, including a second pass after the reboot on ITSC 2024, IV 2024, ICRA 2025, CDC 2025 and the Korea championships, which found nothing new); many hits were profile pages whose Experience text mentions results but are not posts.
