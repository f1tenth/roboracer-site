...
import { gsap, useGSAP, EASE_OUT_EXPO, MOTION_OK_QUERY, ScrollTrigger } from "../../lib/motion";
 ...
 * and number, and the ticker on IROS 2026.
 */
export default function WorldMapChapter({ className = "" }: WorldMapChapterProps) {
  ...
  useGSAP(
    ...
    { scope: wrapRef, dependencies: [pins, regions, reduced, k, timing, series], revertOnUpdate: true },
  );
