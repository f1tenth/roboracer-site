const DOCS_URL = "https://f1tenth.readthedocs.io/en/main/";
...
export default function Build() {
  return (
    <div className="flex h-[100svh] w-full flex-col pt-nav">
      <h1 className="sr-only">Build the car</h1>
      ...
      <iframe className="min-h-0 w-full flex-1 border-none" src={DOCS_URL} title="RoboRacer build documentation" />
    </div>
  );
}
